...
def top_100():
    ...
    print()
    print(Fore.CYAN + "Choose from the following:" + Style.RESET_ALL)
    print(Fore.GREEN + "1. Top 100 by Market Cap")
    print(Fore.YELLOW + "2. Top 100 by 24h '%' change")
    print(Fore.MAGENTA + "3. Top 100 by 24h volume")
    ...
    for currency in data:
        ...
        if volume is not None:
            volume_string = '{:,}'.format(round(volume))
...
api_key = 'dd0f35aa-337a-4651-ad75-a1166406b1e3'
headers = {'X-CMC_PRO_API_KEY': api_key}
...
data = results["data"]
table = PrettyTable(['Asset', 'Price', 'Market Cap',
                    'Volume', '1h', '24h', '7d'])
